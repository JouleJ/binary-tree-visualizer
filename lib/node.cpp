...
class NodeImpl : public Node {
  ...
  public:
    NodeImpl(QString _content, std::unique_ptr<Node> _left,
    ...
    const Node *getLeftChild() const override { return left.get(); }

    const Node *getRightChild() const override { return right.get(); }
};
...
class LeafImpl : public Node {
  ...
  public:
    ...
    const Node *getLeftChild() const override { return nullptr; }

    const Node *getRightChild() const override { return nullptr; }
};
} // namespace
