...
public:
    explicit RequestForm(QWidget* parent, const lib::RequestScheme* _requestScheme);

public slots:
    void onAdjacentButtonClicked();

signals:
    void userRequested(const lib::RequestScheme* requestScheme, bool isRequestValid, const int64_t* firstValue, size_t valueCount);
};
...
private slots:
    void onUserRequested(const lib::RequestScheme* requestScheme, bool isRequestValid, const int64_t* firstValue, size_t valueCount);
